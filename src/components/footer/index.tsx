    ...
    <FooterContainer>
      <InnerContainer>
        <AboutContainer>
          ...
          <AboutText>
            Yourcar is a Car renting and selling company located in may
        ...
        <SectionContainer>
          ...
          <HorizontalContainer>
            ...
            <SmallText>+91 555-234-846</SmallText>
          </HorizontalContainer>
        </SectionContainer>
        <SectionContainer>
      ...
      <BottomContainer>
        <CopyrightText>
          Copyrigth &copy; {new Date().getFullYear()} Yourcar. All rights reserved
        </CopyrightText>
      </BottomContainer>
    </FooterContainer>
  );
